...
| `knowledge_graph.ttl` `knowledge_graph.graphml` | Phase 4: Knowledge Representation and Semantic Mapping | Output of Phase 4, containing a serialised RDF/Turtle knowledge graph and graphml file used to create an interactive visualisation, available at [Gephi Lite](https://lite.gephi.org/?file=https://gist.githubusercontent.com/mluisab/a48178b9ed4db858a2bf1c46e03c15c9/raw/870e83dfb02ed8b38000e6057bbf911e424ce729/knowledge_graph.graphml.json). |
